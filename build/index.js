...
var ActionCard = function (prop) {
    return (React__default['default'].createElement("div", { className: "flex flex-col justify-center rounded-3xl jurne-card bg-white p-1.5" },
        React__default['default'].createElement("div", { className: "flex flex-col max-w-md px-8 py-6 space-y-5 items-center" },
            React__default['default'].createElement("img", { src: prop.src, width: 36, alt: prop.caption }),
            React__default['default'].createElement("h3", { className: "font-bold text-gray-900 text-xl" }, prop.title),
...
var FormInput = function (prop) {
    return (React__default['default'].createElement("div", { className: "form-input" },
        React__default['default'].createElement(reactBootstrap.Form.Label, null, "Username"),
        React__default['default'].createElement(reactBootstrap.Form.Control, { className: "text-input-field", type: "email", placeholder: "Enter email" })));
};
...
var ConsentCard = function (prop) {
    return (React__default['default'].createElement("div", { className: "flex flex-col justify-center rounded-3xl jurne-card bg-white p-1.5" },
        React__default['default'].createElement("div", { className: "flex flex-col max-w-md px-8 py-6 space-y-5" },
            React__default['default'].createElement("span", { className: "consent-title items-center" }, prop.title),
            React__default['default'].createElement("span", { className: "consent-body items-center" }, prop.agreement),
            React__default['default'].createElement("ul", null, prop.pii.map(function (item) { return React__default['default'].createElement("li", { className: "pii-list-item" }, item); }))),
        React__default['default'].createElement("div", { className: "row col-flex" },
            React__default['default'].createElement("div", { className: "col-sm text-center" },
                React__default['default'].createElement(Button, { title: prop.back, style: "secondary" })),
            React__default['default'].createElement("div", { className: "col-sm text-center" },
